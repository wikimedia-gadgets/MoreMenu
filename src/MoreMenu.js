...
$(() => {
    ...
    function drawMenuVector(parentKey, html) {
        html = `<nav id="p-${parentKey}" role="navigation" class="mw-portlet mw-portlet-${parentKey} vector-menu vector-dropdown vector-menu-dropdown vector-has-collapsible-items mm-${parentKey} mm-tab" `
