...
$(() => {
    ...
    function drawMenuVector(parentKey, html) {
        html = `<div id="p-${parentKey}" role="navigation" class="mw-portlet mw-portlet-cactions vector-menu vector-menu-dropdown vector-menu-dropdown-noicon mm-${parentKey} mm-tab" `
            + `aria-labelledby="p-${parentKey}-label" style="z-index: 99">`
            + `<input type="checkbox" class="vector-menu-checkbox" aria-labelledby="p-${parentKey}-label">`
