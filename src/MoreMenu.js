...
$(() => {
    ...
    function drawMenuVector(parentKey, html) {
        html = `<nav id="p-${parentKey}" role="navigation" class="mw-portlet mw-portlet-${parentKey} vector-menu-dropdown-noicon vector-menu vector-menu-dropdown mm-${parentKey} mm-tab" `
            ...
            + `<label id="p-${parentKey}-label" class="vector-menu-heading"><span class="vector-menu-heading-label">${msg(parentKey)}</span><a href="#"></a></label>`
