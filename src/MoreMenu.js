...
$(() => {
    ...
    function drawMenuVector(parentKey, html) {
        html = `<div id="p-${parentKey}" role="navigation" class="vectorMenu vector-menu vector-menu-dropdown mm-${parentKey} mm-tab" `
            + `aria-labelledby="p-${parentKey}-label" style="z-index: 99">`
            + `<input type="checkbox" class="vectorMenuCheckbox vector-menu-checkbox" aria-labelledby="p-${parentKey}-label">`
